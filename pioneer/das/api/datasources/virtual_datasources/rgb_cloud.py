...
class RGBCloud(VirtualDatasource):
    ...
    def get_rgb_from_camera_projection(self, pcloud_ds:str, camera_ds:str, undistort:bool=False, return_mask:bool=False):
    ...
    def __getitem__(self, key:Any):
        ...
        rgb_data, mask = self.get_rgb_from_camera_projection(pcloud_sample, self.original_image_datasource, undistort=self.undistort, return_mask=True)
